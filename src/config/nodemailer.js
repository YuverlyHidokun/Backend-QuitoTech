...
const sendMailToUser2 = (userMail, token) => {
    let mailOptions = {
        ...
        html: `
            ...
            <p><a href="${process.env.VITE_FRONTEND_URL}/quitotech/propietario/confirmar/${encodeURIComponent(token)}" style="color: #4CAF50; font-weight: bold;">Verificar mi cuenta</a></p>
...
const sendMailToAdmin = (userMail, tienda, token) => {
    ...
    let mailOptions = {
        ...
        html: `
            ...
            <p>Haz clic <a href="${process.env.VITE_FRONTEND_URL}/quitotech/propietario/confirmartienda/${encodeURIComponent(token)}">aquí</a> para verificar la tienda.</p>
            <strong><p>----------------------------------------------------------------------------------------------------</p></strong>
            <p style="color: grey;">Este es un correo electrónico generado por el sistema. No responda a este correo electrónico.</p>
        `
    };
